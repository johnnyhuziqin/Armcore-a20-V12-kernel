...
//add by Lynx+ 20130418
	if (client == NULL)
	 ...
	 //       printk("Lynx ===>%s: secs=%d, mins=%d, hours=%d, mday=%d, mon=%d, year=%d\n",\
...
int pcf8563_read_time (struct rtc_time *tm)
{
	return pcf8563_get_datetime(this_client, tm);
}
EXPORT_SYMBOL(pcf8563_read_time);
//add by Lynx- 20130417
...
//add by Lynx+ 20130417
int pcf8563_set_time (struct rtc_time *tm)
{
	return pcf8563_set_datetime(this_client, tm);

}
EXPORT_SYMBOL(pcf8563_set_time);
//add by Lynx- 20130417
